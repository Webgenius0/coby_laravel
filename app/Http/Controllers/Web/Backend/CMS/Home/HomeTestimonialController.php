...
class HomeTestimonialController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = CMS::where('page', PageEnum::HOME)->where('section', SectionEnum::TESTIMONIAL)->latest()->get();
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($data) {
                    return '<div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                <a href="' . route('cms.home.testimonial.edit', ['id' => $data->id]) . '" type="button" class="btn btn-primary fs-14 text-white edit-icn" title="Edit">
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $validatedData['section'] = SectionEnum::TESTIMONIAL->value;
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('cms.home.testimonial.index')->with('t-success', 'Updated successfully');
        } catch (Exception $e) {
            return redirect()->back()->with('t-error', $e->getMessage());
        }
    }
