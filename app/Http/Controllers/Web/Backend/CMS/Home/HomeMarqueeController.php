...
class HomeMarqueeController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = CMS::where('page', PageEnum::HOME)->where('section', SectionEnum::HOME_MARQUEE)->latest()->get();
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($data) {
                    return '<div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                <a href="' . route('cms.home.marquee.edit', ['id' => $data->id]) . '" type="button" class="btn btn-primary fs-14 text-white edit-icn" title="Edit">
        ...
        return view("backend.layouts.cms.home.marquee.index");
    }
    ...
    {
        return view("backend.layouts.cms.home.marquee.create");
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('cms.home.marquee.index')->with('t-success', 'Created successfully');
        } catch (Exception $e) {
    ...
    {
        $marquee = CMS::findOrFail($id);
        return view("backend.layouts.cms.home.marquee.update", compact("marquee"));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('cms.home.marquee.index')->with('t-success', 'Updated successfully');
        } catch (Exception $e) {
            return redirect()->back()->with('t-error', $e->getMessage());
        }
    }
