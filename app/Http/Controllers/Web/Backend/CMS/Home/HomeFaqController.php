...
class HomeFaqController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = CMS::where('page', PageEnum::HOME)->where('section', SectionEnum::FAQS)->latest()->get();
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($data) {
                    return '<div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                <a href="' . route('cms.home.faq.edit', ['id' => $data->id]) . '" type="button" class="btn btn-primary fs-14 text-white edit-icn" title="Edit">
        ...
        $faq = CMS::where('page', PageEnum::HOME)->where('section', SectionEnum::FAQ)->latest()->first();

        return view("backend.layouts.cms.home.faq.index", compact("faq"));
    }
    ...
    {
        return view("backend.layouts.cms.home.faq.create");
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $validatedData['section'] = SectionEnum::FAQS->value;
            ...
            return redirect()->route('cms.home.faq.index')->with('t-success', 'Created successfully');
        } catch (Exception $e) {
    ...
    public function show(string $id)
    {
        ...
        return view("backend.layouts.cms.home.faq.update", compact("faq"));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('cms.home.faq.index')->with('t-success', 'Updated successfully');
        } catch (Exception $e) {
            return redirect()->back()->with('t-error', $e->getMessage());
        }
    }
    ...
    public function content(Request $request)
    {
        ...
        try {
            $validatedData['page'] = PageEnum::HOME->value;
            $validatedData['section'] = SectionEnum::FAQ->value;
