...
class AboutCoreValueController extends Controller
{
    ...
    public function index(Request $request)
    {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($data) {
                    return '<div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                <a href="' . route('cms.about.corevalue.edit', ['id' => $data->id]) . '" type="button" class="btn btn-primary fs-14 text-white edit-icn" title="Edit">
        ...
        $corevalue = CMS::where('page', PageEnum::ABOUT)->where('section', SectionEnum::CORE_VALUE)->latest()->first();

        return view("backend.layouts.cms.about.corevalue.index", compact("corevalue"));
    }
    ...
    {
        return view("backend.layouts.cms.about.corevalue.create");
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('cms.about.corevalue.index')->with('t-success', 'Created successfully');
        } catch (Exception $e) {
    ...
    {
        $core = CMS::findOrFail($id);
        return view("backend.layouts.cms.about.corevalue.update", compact("core"));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('cms.about.corevalue.index')->with('t-success', 'Updated successfully');
        } catch (Exception $e) {
            return redirect()->back()->with('t-error', $e->getMessage());
        }
    }
    ...
    public function content(Request $request)
    {
        ...
        try {
            $validatedData['page'] = PageEnum::ABOUT->value;
            $validatedData['section'] = SectionEnum::CORE_VALUE->value;
