...
class AboutArticleOneController extends Controller
{

    public function index()
    {
        $articleone = CMS::where('page', PageEnum::ABOUT->value)->where('section', SectionEnum::ABOUT_ARTICLE_ONE->value)->first();
        return view('backend.layouts.cms.about.articleone', compact('articleone'));
    }
    public function update(Request $request)
    {
        ...
        try {
            ...
            $validatedData['section'] = SectionEnum::ABOUT_ARTICLE_ONE->value;
            ...
            return redirect()->route('cms.about.articleone')->with('t-success', 'Updated successfully');
        } catch (Exception $e) {
