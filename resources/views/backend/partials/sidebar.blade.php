    ...
    <div class="app-sidebar" style="overflow: scroll">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu mt-2">
                ...
                <li class="slide">
                    <a class="side-menu__item {{  request()->routeIs('country') ? 'has-link' : '' }}" href="{{ route('country.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="side-menu__icon" viewBox="0 0 16 16">
                            <path d="M15 14l-5-5-5 5v-3l10 -10z" />
                        </svg>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('cms.home.marquee.index') }}" class="slide-item">Marquee Section</a></li>
                        <li><a href="{{ route('cms.home.howitwork.index') }}" class="slide-item">How It Works Section</a></li>
                        <li><a href="{{ route('cms.home.testimonial.index') }}" class="slide-item">Testimonial</a></li>
                        <li><a href="{{ route('cms.home.faq.index') }}" class="slide-item">FAQ Section</a></li>
                        <li><a href="{{ route('cms.home.qoute.index') }}" class="slide-item">Qoute Section</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('cms.about.articleone.index') }}" class="slide-item">Article One Section</a></li>
                        <li><a href="{{ route('cms.about.articletwo.index') }}" class="slide-item">Article Two Section</a></li>
                        <li><a href="{{ route('cms.about.missionvision.index') }}" class="slide-item">Mission & Vision Section</a></li>
                        <li><a href="{{ route('cms.about.corevalue.index') }}" class="slide-item">Core Values Section</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Common</span><i class="angle fa fa-angle-right"></i>
                    </a>

                    <ul class="slide-menu">
                        <li><a href="{{ route('cms.common.footer.index') }}" class="slide-item">Footer</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Form</span><i class="angle fa fa-angle-right"></i>
                    </a>
