@extends('backend.app', ['title' => 'Create Mission Vision'])
    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">CMS : Create Mission Vision</h1>
                </div>
                        ...
                        <div class="tab-pane active show" id="editProfile">
                            <div class="card">
                                <div class="card-body border-0">
                                    <form method="POST" action="{{ route('cms.about.missionvision.store') }}" enctype="multipart/form-data">
                                        @csrf
